...
class Ui__payment(object):
    def setupUi(self, _payment):
        ...
        self.label_4.setGeometry(QtCore.QRect(90, 30, 730, 90))
        font = QtGui.QFont()
        font.setPointSize(40)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.pushButton_8 = QtWidgets.QPushButton(self.widget)
        self.pushButton_8.setGeometry(QtCore.QRect(960, 30, 181, 61))
        font = QtGui.QFont()
        ...
        self.pushButton_10.setGeometry(QtCore.QRect(800, 700, 291, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
