...
class Ui_cash_2(object):
    def setupUi(self, cash_2):
        ...
        self.pushButton.setGeometry(QtCore.QRect(960, 50, 181, 61))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.pushButton.setFont(font)
        self.pushButton.setObjectName("pushButton")
        self.label_2 = QtWidgets.QLabel(self.widget)
        self.label_2.setGeometry(QtCore.QRect(780, 270, 231, 61))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.widget)
        self.label_3.setGeometry(QtCore.QRect(690, 330, 151, 61))
        font = QtGui.QFont()
        font.setPointSize(30)
